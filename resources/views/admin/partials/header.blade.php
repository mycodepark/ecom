    ...
    <ul class="app-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                <li>
                    <a class="dropdown-item" href="{{ route('admin.settings') }}"><i class="fa fa-cog fa-lg"></i> Ayarlar</a>
                </li>
                <li>
                    <a class="dropdown-item" href="{{ route('admin.profiles.index') }}"><i class="fa fa-user fa-lg"></i> Profilim</a>
                </li>
                <li>
                    <a class="dropdown-item" href="{{ route('admin.logout') }}"><i class="fa fa-sign-out fa-lg"></i> Çıkış</a>
                </li>
            </ul>
        </li>
    </ul>
