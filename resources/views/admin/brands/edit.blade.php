                ...
                <form action="{{ route('admin.brands.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="name">Marka Adı <span class="m-l-5 text-danger"> *</span></label>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                @endif
                                <div class="col-md-10">
                                    <label class="control-label">Marka Logo</label>
                    ...
                    <div class="tile-footer">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <a class="btn btn-secondary" href="{{ route('admin.brands.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Vazgeç</a>
                    </div>
                </form>
            </div>
        </div>
