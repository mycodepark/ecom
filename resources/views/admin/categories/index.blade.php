...
@section('content')
    <div class="app-title">
        ...
        <a href="{{ route('admin.categories.create') }}" class="btn btn-primary pull-right">Yeni Kategori Ekle</a>
    </div>
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center"> Özellikli </th>
                                <th class="text-center"> Menüde Göster </th>
