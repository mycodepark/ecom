...
@section('content')
    <div class="app-title">
        ...
        <a href="{{ route('admin.attributes.create') }}" class="btn btn-primary pull-right">Yeni Özellik Ekle</a>
    </div>
                ...
                <div class="tile-body">
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tr>
                            ...
                            <th class="text-center"> Filtrelenebilir </th>
